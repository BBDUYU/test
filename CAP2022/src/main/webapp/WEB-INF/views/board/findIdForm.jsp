...
<main class="form-signin" span style="font-family: 'Gowun Dodum' !important;">
  ...
  <form:form modelAttribute="userVO" class="login-form" name="findIdForm" method="post" action="findId">
    ...
    <div class="form-floating">
      ...
      <input name='name' type="text" class="form-control" id="floatingInput" placeholder="UserId" required="true">
    ...
    <div class="d-grid gap-2 d-mx-auto">
    	...
    	<button type="button" class="w-100 btn btn-lg btn-primary"onclick="location.href='findPass' ">비밀번호 찾기</button>
