...
<div class="container">
  ...
  <li class="nav-item">
	...
	<input type="submit" class="nav-link" aria-current="page" id="search"  value="반나절투어 예약정보" />
   ...
   <li class="nav-item">
	...
	<input type="submit" class="nav-link active" aria-current="page" id="search"  value="하루투어 예약정보" />
    ...
    <div class="col-12">
        ...
        <div class="row mb-2">
         <c:forEach var="ores" items="${oresList}">
         <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <h3 class="mb-0">${ores.name}</h3>
          <div class="mb-1 text-muted">예약자이름:${ores.username}</div>
          <p class="card-text mb-auto">결제금액:${ores.total}</p>
		<div class="d-grid gap-2 d-md-flex justify-content-md-end">
			  <form name="odelete" action="odelete">
				  <div class="container">
				  <input type="hidden" id="rsno" name="rsno" value="${ores.rsno}"/> 
				    <p class="float-end mb-1">
				     <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">예약취소</button>
				     			  <button class="btn btn-primary" type="button" onclick="location.href='oreview?ono=${ores.ono}' ">후기작성</button>
