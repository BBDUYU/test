...
<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">${half.name}</h1>
...
<div class="container">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
             <img src="<c:url value='/resources/images/${half.img1}'/>" height="600"  class="d-block w-100" alt="">

    </div>
    <div class="carousel-item">
             <img src="<c:url value='/resources/images/${half.img2}'/>" height="600" class="d-block w-100" alt="">
    </div>
...
<ol class="list-group list-group-numbered">
  <li class="list-group-item d-flex justify-content-between align-items-start">
    <div class="ms-2 me-auto">
      <div class="fw-bold">${half.name}</</div>
   ...
   <li class="list-group-item">${half.price}원</li>
   ...
   <div class="accordion-item" style="text-align : center;">
    ...
    <div id="panelsStayOpen-collapseZ" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingZ">
      <div class="accordion-body">
      	...
      	 <img src="<c:url value='/resources/images/${half.picture}' />"  width="720" alt="">
      	<br>
      	<br>
      	<br>
		 ${half.content}
  ...
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
      <div class="accordion-body" >
        <strong>이용 시간</strong> <br>${half.time}<br>
      	<strong>위치 안내</strong> <br>
      	 <iframe src="${half.place}" 
    ...
    <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
      <div class="accordion-body">
       <div class="col-12">
	              ...
	              <div class="row mb-2">
	      <c:forEach var="hre" items="${hreviewList}">
	        
	
	         <div class="col-md-6">
	      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
	        <div class="col p-4 d-flex flex-column position-static">
	          <h3 class="mb-0">${hre.title}</h3>
	          <div class="mb-1 text-muted">${hre.regdate}</div>
	          <input type="hidden" id="userid" name="userid" value="${hre.userid}" required />
	         
	          <p class="card-text mb-auto">${hre.content}</p>
...
<%if(session.getAttribute("userId") != null){ %>
                    ...
                    <form name="wish" action="wish" method="post" onsubmit="return errCodeCheck()">
                	<input type="hidden" id="userid" name="userid" value="${userId}" />
                	<input type="hidden" id="hno" name="hno" value="${half.hno}" />
                	<input type="hidden" id="img1" name="img1" value="${half.img1}" />
                    <input type="hidden" id="name" name="name" value="${half.name}" />
                    <input type="hidden" id="price" name="price" value="${half.price}" />
...
<%if(session.getAttribute("userId") != null){ %>
    ...
    <button type="button" class="btn btn-primary btn-lg" onclick="location.href='/cap/board/hreserve?hno=${half.hno}' " >예약하기</button>
   <% } %>
