...
<div class="container">
  ...
  <div class="py-5 text-center">
    ...
    <form modelAttribute="halfVO" name="join" method='post'  Action='write' onsubmit='return Check_Form()' enctype="multipart/form-data" >
          <div class="row g-3">
            <div class="col-sm-6">
			...
			<div class="col-sm-6">
              <label for="name" class="form-label">이용시간</label>
              <textarea type="text" class="form-control" name="time" placeholder="TIME" required></textarea>  
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" name="place" placeholder="LINK" required>
              <span class="fieldError"></span> 
