...
<div class="container">
  ...
  <li class="nav-item">
    <a class="nav-link" href="/cap/board/res">예약정보</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="/cap/board/review">후기작성</a>
  </li>
</ul>
...
<div class="mb-3">
  ...
  <input type="hidden" id="username" name="username" value="${userName}" /> <!– 세션변수 ->
 ...
 <footer class="text-muted py-5">
  <div class="container">
    ...
    <p class="float-end mb-1">
         <button class="btn btn-lg btn-primary" type="reset">재작성</button>
    
     <button class="btn btn-lg btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">등록하기</button>
