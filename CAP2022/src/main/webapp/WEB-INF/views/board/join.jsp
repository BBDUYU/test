...
<div class="container">
  <main span style="font-family: 'Gowun Dodum' !important;">
   ...
   <form modelAttribute="userVO" name="join" method='post'  Action='join' onsubmit='return Check_Form()' >
          <div class="row g-3">
            <div class="col-sm-6">
              <label for="firstName" class="form-label">아이디</label>
              <input type="text" class="form-control" id='userId' name="userId" placeholder="ID" required onblur="idCheck();">
            ...
            <div class="col-12">
             ...
             <div class="col-12">
              ...
              <div class="input-group has-validation">
                <input type="password" class="form-control" name="passwd_re" placeholder="PassWord Check" required>
