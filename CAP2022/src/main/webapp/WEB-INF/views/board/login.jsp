...
<main class="form-signin" span style="font-family: 'Gowun Dodum' !important;">
  ...
  <form:form modelAttribute="userVO" class="login-form" name="login-form" method="post" action="login">
    ...
    <div class="form-floating">
      <span class="error"><form:errors path="passwd" /></span>
    ...
    <div class="d-grid gap-2 d-mx-auto">
    	...
    	<button type="button" class="w-100 btn btn-lg btn-primary" onclick="location.href='join' ">회원가입</button>
		<button type="button" class="btn btn-outline-dark" onclick="location.href='findId' ">아이디 찾기</button>
		<button type="button" class="btn btn-outline-dark" onclick="location.href='findPass' ">비밀번호 찾기</button>
	</div>
