...
<form action="wishlist" modelAttribute="searchVO" method="get">
   ...
   <% } %>
      ...
      <form modelAttribute="hresVO" name="join" Action='hreserve' method="post"  enctype="multipart/form-data">
 ...
 <div class="col-md-8">
    <div class="col">
      상품명
       ...
       <div>
       <img src="<c:url value='/resources/images/${half.img1}'/>" width="150" height="150" >
       <span class="mb-0" style="vertical-align:top;font-size:30px">${half.name}</span><br>
       <p class="price" style="vertical-align:bottom;font-size:20px;text-align:right;" >상품가격: ${half.price}원</p>
       <input type='hidden' class="price" size=10 id="price" name="price" value="${half.price}" readonly="readonly" onKeyUp=calculationtest(); required >
       
       </div>
       <input type='hidden' class="name" size=30 id="name" name="name" value="${half.name}" readonly="readonly" required >
       
        </div>
       <input type="hidden" id="hno" name="hno" value="${half.hno}" required />
