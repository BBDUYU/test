...
<main class="container" span style="font-family: 'Gowun Dodum' !important;">
  <div class="bg-light p-5 rounded">
    <h1>로그인 성공</h1>
    <p class="lead">환영합니다,${loginUser.name}씨！</p>
    <a class="btn btn-lg btn-primary" href="/cap/board/editUser?userId=${loginUser.userId}" role="button">회원정보 수정&raquo;</a>
        <a class="btn btn-lg btn-primary" href="/cap/board/main"role="button">메인화면으로&raquo;</a>
