...
<ol class="list-group list-group-numbered">
  ...
  <li class="list-group-item d-flex justify-content-between align-items-start">
   ...
   <li class="list-group-item">상품가격<br> ${ores.price} 원</li>
   <li class="list-group-item">총 결제금액<br> ${ores.total} 원</li>
 
   <li class="list-group-item">인원<br> ${ores.num} 명
...
<footer class="text-muted py-5">
  <div class="container">
   ...
   <a class="btn btn-lg btn-primary"  href="/cap/board/main" role="button">확인</a>
