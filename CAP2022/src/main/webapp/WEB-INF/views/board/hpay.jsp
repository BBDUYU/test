...
<ol class="list-group list-group-numbered">
  ...
  <li class="list-group-item d-flex justify-content-between align-items-start">
   ...
   <li class="list-group-item">상품가격<br> ${hres.price} 원</li>
   <li class="list-group-item">총 결제금액<br> ${hres.total} 원</li>
 
   <li class="list-group-item">인원<br> ${hres.num} 명
...
<footer class="text-muted py-5">
  <div class="container">
	...
	<input type="hidden" id="keyword" name="keyword" value="${userId}" />
	<input type="submit" class="btn btn-lg btn-primary" aria-current="page" id="search" onclick="tmpConsole()" value="예약정보" />
	
	</form>
   <input type="button" class="btn btn-lg btn-primary"  onclick="location.href='/cap/board/main'" value="확인">
  </div>
